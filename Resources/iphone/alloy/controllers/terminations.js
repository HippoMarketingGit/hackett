...
function Controller() {
    ...
    $.__views.shorteningDeviceView.add($.__views.__alloyId286);
    ...
    $.__views.__alloyId288.add($.__views.shorteningImage);
    ...
    $.__views.__alloyId289.add($.__views.shorteningDeviceText);
    ...
    $.__views.upperTermView.add($.__views.__alloyId296);
    ...
    $.__views.__alloyId298.add($.__views.upperTermImage);
    ...
    $.__views.upperTermView.add($.__views.__alloyId299);
    ...
    $.__views.__alloyId299.add($.__views.upperTermText);
    ...
    createPicker ? $.__views.__alloyId300.addEventListener("click", createPicker) : __defers["$.__views.__alloyId300!click!createPicker"] = true;
    ...
    __defers["$.__views.__alloyId300!click!createPicker"] && $.__views.__alloyId300.addEventListener("click", createPicker);
    _.extend($, exports);
}

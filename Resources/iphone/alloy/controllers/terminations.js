...
function Controller() {
    function createPicker(e) {
        ...
        if ("shortening" === e.source.className) {
            ...
            picker.addEventListener("change", function(e) {
                ...
                Ti.API.info("/images/shorteners/" + e.row.title + ".jpg");
    ...
    $.__views.content.add($.__views.__alloyId258);
    ...
    $.__views.shorteningDeviceView.add($.__views.__alloyId261);
    ...
    $.__views.__alloyId263.add($.__views.shorteningImage);
    ...
    $.__views.shorteningDeviceView.add($.__views.__alloyId264);
    ...
    $.__views.__alloyId264.add($.__views.shorteningDeviceText);
    ...
    createPicker ? $.__views.__alloyId265.addEventListener("click", createPicker) : __defers["$.__views.__alloyId265!click!createPicker"] = true;
    ...
    $.__views.lowerTermView.add($.__views.__alloyId266);
    ...
    $.__views.__alloyId268.add($.__views.lowerTermImage);
    ...
    $.__views.lowerTermView.add($.__views.__alloyId269);
    ...
    $.__views.__alloyId269.add($.__views.lowerTermText);
    ...
    createPicker ? $.__views.__alloyId270.addEventListener("click", createPicker) : __defers["$.__views.__alloyId270!click!createPicker"] = true;
    ...
    $.__views.upperTermView.add($.__views.__alloyId271);
    ...
    $.__views.__alloyId273.add($.__views.upperTermImage);
    ...
    $.__views.upperTermView.add($.__views.__alloyId274);
    ...
    $.__views.__alloyId274.add($.__views.upperTermText);
    ...
    createPicker ? $.__views.__alloyId275.addEventListener("click", createPicker) : __defers["$.__views.__alloyId275!click!createPicker"] = true;
    ...
    __defers["$.__views.__alloyId265!click!createPicker"] && $.__views.__alloyId265.addEventListener("click", createPicker);
    __defers["$.__views.lowerTermText!click!createPicker"] && $.__views.lowerTermText.addEventListener("click", createPicker);
    __defers["$.__views.__alloyId270!click!createPicker"] && $.__views.__alloyId270.addEventListener("click", createPicker);
    __defers["$.__views.upperTermText!click!createPicker"] && $.__views.upperTermText.addEventListener("click", createPicker);
    __defers["$.__views.__alloyId275!click!createPicker"] && $.__views.__alloyId275.addEventListener("click", createPicker);
    _.extend($, exports);
}

...
function Controller() {
    ...
    $.__views.specifications.add($.__views.__alloyId262);
    ...
    $.__views.specifications.add($.__views.__alloyId263);
    ...
    if (Alloy.isTablet) {
        ...
        $.__views.slingRequirements.add($.__views.__alloyId270);
        ...
        $.__views.slingSpecification.add($.__views.__alloyId271);
    ...
    if (!Alloy.isTablet) {
        ...
        $.__views.valuesReqs.add($.__views.__alloyId272);
        $.__views.labels = Ti.UI.createView({
            height: Ti.UI.SIZE,
            id: "labels",
            layout: "vertical",
    ...
    if (!Alloy.isTablet) {
        ...
        $.__views.valuesSling.add($.__views.__alloyId277);
        $.__views.labels = Ti.UI.createView({
            height: Ti.UI.SIZE,
            id: "labels",
            layout: "vertical",
        ...
        $.__views.labels.add($.__views.__alloyId281);
        ...
        $.__views.labels.add($.__views.__alloyId282);
        $.__views.slingSpecification = Ti.UI.createView({
            height: Ti.UI.SIZE,
            id: "slingSpecification",
            layout: "vertical",
    ...
    $.__views.content.add($.__views.__alloyId283);
    ...
    $.__views.__alloyId283.add($.__views.descriptionContainer);
    ...
    $.__views.__alloyId283.add($.__views.slingPartcode);
    ...
    $.__views.__alloyId284.add($.__views.quotedPrice);
    ...
    $.__views.__alloyId283.add($.__views.slingAssemblyImg);

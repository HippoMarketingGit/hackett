...
function Controller() {
    ...
    $.__views.__alloyId208 = Ti.UI.createImageView(function() {
        var o = {};
        _.extend(o, {
            bottom: "8dip",
            width: "90%"
    ...
    $.__views.header.add($.__views.__alloyId208);
    ...
    $.__views.slingConfiguration.add($.__views.__alloyId209);
    ...
    $.__views.back.add($.__views.__alloyId211);

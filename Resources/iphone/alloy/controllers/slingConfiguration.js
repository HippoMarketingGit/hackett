...
function Controller() {
    ...
    $.__views.__alloyId224 = Ti.UI.createImageView(function() {
        var o = {};
        _.extend(o, {
            bottom: "8dip",
            width: "90%"
    ...
    $.__views.header.add($.__views.__alloyId224);
    ...
    $.__views.slingConfiguration.add($.__views.__alloyId225);
    ...
    $.__views.footer.add($.__views.__alloyId226);
    ...
    $.__views.back.add($.__views.__alloyId227);

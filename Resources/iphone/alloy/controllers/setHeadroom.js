...
function Controller() {
    ...
    $.__views.setHeadroom.add($.__views.__alloyId200);
    ...
    closeModal ? $.__views.__alloyId201.addEventListener("click", closeModal) : __defers["$.__views.__alloyId201!click!closeModal"] = true;
    ...
    $.__views.setHeadroom.add($.__views.__alloyId202);
    ...
    $.__views.content.add($.__views.__alloyId203);
    ...
    __alloyId213.push($.__views.headMeterDone);
    $.__views.__alloyId211 = Ti.UI.iOS.createToolbar({
        items: __alloyId213,
        id: "__alloyId211"
    });
    $.__views.headMeter = Ti.UI.createTextField({
        ...
        color: "#000",
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId211,
        id: "headMeter",
        value: "00"
    });
    $.__views.__alloyId209.add($.__views.headMeter);
    $.__views.__alloyId211 = Ti.UI.iOS.createToolbar({
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId211,
        id: "headMeter",
    ...
    __alloyId219.push($.__views.headFractionDone);
    $.__views.__alloyId217 = Ti.UI.iOS.createToolbar({
        items: __alloyId219,
        id: "__alloyId217"
    });
    $.__views.headFraction = Ti.UI.createTextField({
        ...
        color: "#000",
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId217,
        id: "headFraction",
        value: "00"
    });
    $.__views.__alloyId209.add($.__views.headFraction);
    $.__views.__alloyId217 = Ti.UI.iOS.createToolbar({
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId217,
        id: "headFraction",
    ...
    $.__views.__alloyId203.add($.__views.__alloyId221);
    ...
    setHead ? $.__views.__alloyId222.addEventListener("click", setHead) : __defers["$.__views.__alloyId222!click!setHead"] = true;
    ...
    $.__views.scrollView.add($.__views.__alloyId223);
    ...
    __defers["$.__views.__alloyId201!click!closeModal"] && $.__views.__alloyId201.addEventListener("click", closeModal);
    __defers["$.__views.__alloyId222!click!setHead"] && $.__views.__alloyId222.addEventListener("click", setHead);
    _.extend($, exports);
}

...
function Controller() {
    ...
    $.__views.masterlinkView.add($.__views.__alloyId124);
    ...
    $.__views.masterlinkView.add($.__views.__alloyId126);
    ...
    $.__views.__alloyId127.add($.__views.standard);
    ...
    $.__views.standard.add($.__views.__alloyId128);
    ...
    $.__views.standard.add($.__views.__alloyId129);
    ...
    $.__views.standard.add($.__views.__alloyId130);
    ...
    $.__views.__alloyId127.add($.__views.oversized);
    ...
    $.__views.oversized.add($.__views.__alloyId132);
    ...
    $.__views.oversized.add($.__views.__alloyId133);
    ...
    $.__views.oversized.add($.__views.__alloyId134);

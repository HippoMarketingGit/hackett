...
function Controller() {
    ...
    $.__views.nominalLength.add($.__views.__alloyId131);
    ...
    closeModal ? $.__views.__alloyId132.addEventListener("click", closeModal) : __defers["$.__views.__alloyId132!click!closeModal"] = true;
    ...
    $.__views.nominalLength.add($.__views.__alloyId133);
    ...
    __alloyId144.push($.__views.legMeterDone);
    $.__views.__alloyId142 = Ti.UI.iOS.createToolbar({
        items: __alloyId144,
        id: "__alloyId142"
    });
    $.__views.legMeter = Ti.UI.createTextField({
        ...
        color: "#000",
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId142,
        id: "legMeter",
        value: "00"
    });
    $.__views.__alloyId140.add($.__views.legMeter);
    $.__views.__alloyId142 = Ti.UI.iOS.createToolbar({
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId142,
        id: "legMeter",
    ...
    __alloyId150.push($.__views.legFractionDone);
    $.__views.__alloyId148 = Ti.UI.iOS.createToolbar({
        items: __alloyId150,
        id: "__alloyId148"
    });
    $.__views.legFraction = Ti.UI.createTextField({
        ...
        color: "#000",
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId148,
        id: "legFraction",
        value: "00"
    });
    $.__views.__alloyId140.add($.__views.legFraction);
    $.__views.__alloyId148 = Ti.UI.iOS.createToolbar({
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId148,
        id: "legFraction",
    ...
    setLength ? $.__views.__alloyId153.addEventListener("click", setLength) : __defers["$.__views.__alloyId153!click!setLength"] = true;
    ...
    __defers["$.__views.__alloyId132!click!closeModal"] && $.__views.__alloyId132.addEventListener("click", closeModal);
    __defers["$.__views.__alloyId153!click!setLength"] && $.__views.__alloyId153.addEventListener("click", setLength);
    _.extend($, exports);
}

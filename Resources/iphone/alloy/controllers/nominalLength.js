...
function Controller() {
    ...
    closeModal ? $.__views.__alloyId129.addEventListener("click", closeModal) : __defers["$.__views.__alloyId129!click!closeModal"] = true;
    ...
    __alloyId141.push($.__views.legMeterDone);
    $.__views.__alloyId139 = Ti.UI.iOS.createToolbar({
        items: __alloyId141,
        id: "__alloyId139"
    });
    $.__views.legMeter = Ti.UI.createTextField({
        ...
        color: "#000",
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId139,
        id: "legMeter",
        value: "00"
    });
    $.__views.__alloyId137.add($.__views.legMeter);
    $.__views.__alloyId139 = Ti.UI.iOS.createToolbar({
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId139,
        id: "legMeter",
    ...
    __alloyId147.push($.__views.legFractionDone);
    ...
    $.__views.legFraction = Ti.UI.createTextField({
        ...
        color: "#000",
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId145,
        id: "legFraction",
        value: "00"
    });
    $.__views.__alloyId137.add($.__views.legFraction);
    $.__views.__alloyId145 = Ti.UI.iOS.createToolbar({
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId145,
        id: "legFraction",
    ...
    $.__views.__alloyId131.add($.__views.__alloyId149);
    ...
    setLength ? $.__views.__alloyId150.addEventListener("click", setLength) : __defers["$.__views.__alloyId150!click!setLength"] = true;
    ...
    __defers["$.__views.__alloyId129!click!closeModal"] && $.__views.__alloyId129.addEventListener("click", closeModal);
    __defers["$.__views.__alloyId150!click!setLength"] && $.__views.__alloyId150.addEventListener("click", setLength);
    _.extend($, exports);
}

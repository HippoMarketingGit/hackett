...
function Controller() {
    ...
    $.__views.nominalLength.add($.__views.__alloyId130);
    ...
    closeModal ? $.__views.__alloyId131.addEventListener("click", closeModal) : __defers["$.__views.__alloyId131!click!closeModal"] = true;
    ...
    __alloyId143.push($.__views.legMeterDone);
    $.__views.__alloyId141 = Ti.UI.iOS.createToolbar({
        items: __alloyId143,
        id: "__alloyId141"
    });
    $.__views.legMeter = Ti.UI.createTextField({
        ...
        color: "#000",
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId141,
        id: "legMeter",
        value: "00"
    });
    $.__views.__alloyId139.add($.__views.legMeter);
    $.__views.__alloyId141 = Ti.UI.iOS.createToolbar({
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId141,
        id: "legMeter",
    ...
    __alloyId149.push($.__views.legFractionDone);
    $.__views.__alloyId147 = Ti.UI.iOS.createToolbar({
        items: __alloyId149,
        id: "__alloyId147"
    });
    $.__views.legFraction = Ti.UI.createTextField({
        ...
        color: "#000",
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId147,
        id: "legFraction",
        value: "00"
    });
    $.__views.__alloyId139.add($.__views.legFraction);
    $.__views.__alloyId147 = Ti.UI.iOS.createToolbar({
        clearOnEdit: true,
        keyboardToolbar: $.__views.__alloyId147,
        id: "legFraction",
    ...
    $.__views.__alloyId133.add($.__views.__alloyId151);
    ...
    setLength ? $.__views.__alloyId152.addEventListener("click", setLength) : __defers["$.__views.__alloyId152!click!setLength"] = true;
    ...
    $.__views.scrollView.add($.__views.__alloyId153);
    ...
    __defers["$.__views.__alloyId131!click!closeModal"] && $.__views.__alloyId131.addEventListener("click", closeModal);
    __defers["$.__views.__alloyId152!click!setLength"] && $.__views.__alloyId152.addEventListener("click", setLength);
    _.extend($, exports);
}

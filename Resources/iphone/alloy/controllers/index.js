...
function Controller() {
    ...
    $.__views.loaderContainer.add($.__views.__alloyId55);
    $.__views.__alloyId56 = Ti.UI.createView(function() {
        var o = {};
        _.extend(o, {
            layout: "vertical",
            width: "90%"
    ...
    $.__views.__alloyId57.add($.__views.username);
    ...
    $.__views.__alloyId61.add($.__views.login);
    ...
    $.__views.__alloyId56.add($.__views.__alloyId62);
    ...
    $.__views.__alloyId56.add($.__views.__alloyId66);

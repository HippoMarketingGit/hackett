...
function Controller() {
    ...
    closeModal ? $.__views.__alloyId170.addEventListener("click", closeModal) : __defers["$.__views.__alloyId170!click!closeModal"] = true;
    ...
    setHead ? $.__views.__alloyId181.addEventListener("click", setHead) : __defers["$.__views.__alloyId181!click!setHead"] = true;
    ...
    __defers["$.__views.__alloyId170!click!closeModal"] && $.__views.__alloyId170.addEventListener("click", closeModal);
    __defers["$.__views.__alloyId181!click!setHead"] && $.__views.__alloyId181.addEventListener("click", setHead);
    _.extend($, exports);
}

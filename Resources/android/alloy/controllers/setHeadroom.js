...
function Controller() {
    ...
    closeModal ? $.addListener($.__views.__alloyId174, "click", closeModal) : __defers["$.__views.__alloyId174!click!closeModal"] = true;
    ...
    setHead ? $.addListener($.__views.__alloyId185, "click", setHead) : __defers["$.__views.__alloyId185!click!setHead"] = true;
    ...
    __defers["$.__views.__alloyId174!click!closeModal"] && $.addListener($.__views.__alloyId174, "click", closeModal);
    __defers["$.__views.__alloyId185!click!setHead"] && $.addListener($.__views.__alloyId185, "click", setHead);
    _.extend($, exports);
}

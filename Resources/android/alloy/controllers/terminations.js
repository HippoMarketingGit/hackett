...
function Controller() {
    ...
    $.__views.content.add($.__views.__alloyId237);
    ...
    $.__views.shorteningDeviceView.add($.__views.__alloyId240);
    ...
    $.__views.__alloyId242.add($.__views.shorteningImage);
    ...
    $.__views.shorteningDeviceView.add($.__views.__alloyId243);
    ...
    $.__views.__alloyId243.add($.__views.shorteningDeviceText);
    ...
    createPicker ? $.__views.__alloyId244.addEventListener("click", createPicker) : __defers["$.__views.__alloyId244!click!createPicker"] = true;
    ...
    $.__views.__alloyId247.add($.__views.lowerTermImage);
    ...
    $.__views.lowerTermView.add($.__views.__alloyId248);
    ...
    $.__views.__alloyId248.add($.__views.lowerTermText);
    ...
    createPicker ? $.__views.__alloyId249.addEventListener("click", createPicker) : __defers["$.__views.__alloyId249!click!createPicker"] = true;
    ...
    $.__views.upperTermView.add($.__views.__alloyId250);
    ...
    $.__views.__alloyId252.add($.__views.upperTermImage);
    ...
    $.__views.upperTermView.add($.__views.__alloyId253);
    ...
    $.__views.__alloyId253.add($.__views.upperTermText);
    ...
    createPicker ? $.__views.__alloyId254.addEventListener("click", createPicker) : __defers["$.__views.__alloyId254!click!createPicker"] = true;
    ...
    __defers["$.__views.__alloyId244!click!createPicker"] && $.__views.__alloyId244.addEventListener("click", createPicker);
    __defers["$.__views.lowerTermText!click!createPicker"] && $.__views.lowerTermText.addEventListener("click", createPicker);
    __defers["$.__views.__alloyId249!click!createPicker"] && $.__views.__alloyId249.addEventListener("click", createPicker);
    __defers["$.__views.upperTermText!click!createPicker"] && $.__views.upperTermText.addEventListener("click", createPicker);
    __defers["$.__views.__alloyId254!click!createPicker"] && $.__views.__alloyId254.addEventListener("click", createPicker);
    _.extend($, exports);
}

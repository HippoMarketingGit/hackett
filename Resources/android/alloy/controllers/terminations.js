...
function Controller() {
    ...
    $.__views.content.add($.__views.__alloyId242);
    ...
    $.__views.shorteningDeviceView.add($.__views.__alloyId245);
    ...
    $.__views.__alloyId247.add($.__views.shorteningImage);
    ...
    $.__views.shorteningDeviceView.add($.__views.__alloyId248);
    ...
    $.__views.__alloyId248.add($.__views.shorteningDeviceText);
    ...
    createPicker ? $.addListener($.__views.__alloyId249, "click", createPicker) : __defers["$.__views.__alloyId249!click!createPicker"] = true;
    ...
    createPicker ? $.addListener($.__views.__alloyId254, "click", createPicker) : __defers["$.__views.__alloyId254!click!createPicker"] = true;
    ...
    $.__views.__alloyId258.add($.__views.lowerTermText);
    ...
    createPicker ? $.addListener($.__views.__alloyId259, "click", createPicker) : __defers["$.__views.__alloyId259!click!createPicker"] = true;
    ...
    __defers["$.__views.__alloyId249!click!createPicker"] && $.addListener($.__views.__alloyId249, "click", createPicker);
    __defers["$.__views.upperTermText!click!createPicker"] && $.addListener($.__views.upperTermText, "click", createPicker);
    __defers["$.__views.__alloyId254!click!createPicker"] && $.addListener($.__views.__alloyId254, "click", createPicker);
    __defers["$.__views.lowerTermText!click!createPicker"] && $.addListener($.__views.lowerTermText, "click", createPicker);
    __defers["$.__views.__alloyId259!click!createPicker"] && $.addListener($.__views.__alloyId259, "click", createPicker);
    _.extend($, exports);
}

...
function Controller() {
    ...
    setLength ? $.__views.__alloyId87.addEventListener("click", setLength) : __defers["$.__views.__alloyId87!click!setLength"] = true;
    ...
    __defers["$.__views.__alloyId87!click!setLength"] && $.__views.__alloyId87.addEventListener("click", setLength);
    _.extend($, exports);
}

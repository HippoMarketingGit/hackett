...
function Controller() {
    ...
    setLength ? $.__views.__alloyId95.addEventListener("click", setLength) : __defers["$.__views.__alloyId95!click!setLength"] = true;
    ...
    __defers["$.__views.__alloyId95!click!setLength"] && $.__views.__alloyId95.addEventListener("click", setLength);
    _.extend($, exports);
}

...
function Controller() {
    ...
    setLength ? $.addListener($.__views.__alloyId88, "click", setLength) : __defers["$.__views.__alloyId88!click!setLength"] = true;
    ...
    __defers["$.__views.__alloyId88!click!setLength"] && $.addListener($.__views.__alloyId88, "click", setLength);
    _.extend($, exports);
}

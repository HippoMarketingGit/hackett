...
function Controller() {
    ...
    openDash ? $.addListener($.__views.__alloyId128, "click", openDash) : __defers["$.__views.__alloyId128!click!openDash"] = true;
    ...
    __defers["$.__views.__alloyId128!click!openDash"] && $.addListener($.__views.__alloyId128, "click", openDash);
    _.extend($, exports);
}

...
function Controller() {
    ...
    openDash ? $.addListener($.__views.__alloyId124, "click", openDash) : __defers["$.__views.__alloyId124!click!openDash"] = true;
    ...
    __defers["$.__views.__alloyId124!click!openDash"] && $.addListener($.__views.__alloyId124, "click", openDash);
    _.extend($, exports);
}

...
function Controller() {
    ...
    $.__views.__alloyId241.add($.__views.devices);
    ...
    $.__views.__alloyId245.add($.__views.upperTermImage);
    $.__views.upper = Ti.UI.createView({
        id: "upper"
    });
    $.__views.__alloyId244.add($.__views.upper);
    ...
    $.__views.upperTermView.add($.__views.__alloyId246);
    ...
    $.__views.__alloyId246.add($.__views.upperTermText);
    ...
    $.__views.lowerTermView.add($.__views.__alloyId247);
    ...
    $.__views.__alloyId247.add($.__views.lower);

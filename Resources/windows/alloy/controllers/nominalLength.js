...
function Controller() {
    ...
    closeModal ? $.addListener($.__views.__alloyId112, "click", closeModal) : __defers["$.__views.__alloyId112!click!closeModal"] = true;
    ...
    setLength ? $.addListener($.__views.__alloyId123, "click", setLength) : __defers["$.__views.__alloyId123!click!setLength"] = true;
    ...
    __defers["$.__views.__alloyId112!click!closeModal"] && $.addListener($.__views.__alloyId112, "click", closeModal);
    __defers["$.__views.__alloyId123!click!setLength"] && $.addListener($.__views.__alloyId123, "click", setLength);
    _.extend($, exports);
}

...
function Controller() {
    ...
    $.__views.__alloyId70.add($.__views.one);
    ...
    $.__views.one.add($.__views.__alloyId71);
    ...
    $.__views.__alloyId71.add($.__views.oneImg);
    ...
    $.__views.__alloyId70.add($.__views.two);
    ...
    $.__views.two.add($.__views.__alloyId72);
    ...
    $.__views.__alloyId72.add($.__views.twoImg);
    ...
    $.__views.__alloyId73.add($.__views.three);
    ...
    $.__views.three.add($.__views.__alloyId74);
    ...
    $.__views.__alloyId74.add($.__views.threeImg);
    ...
    $.__views.__alloyId73.add($.__views.four);
    ...
    $.__views.four.add($.__views.__alloyId75);
    ...
    $.__views.__alloyId75.add($.__views.fourImg);

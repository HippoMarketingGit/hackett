...
function Controller() {
    ...
    $.__views.liftingPoints.add($.__views.__alloyId81);
    ...
    closeModal ? $.addListener($.__views.__alloyId82, "click", closeModal) : __defers["$.__views.__alloyId82!click!closeModal"] = true;
    ...
    $.__views.liftingPoints.add($.__views.__alloyId83);
    ...
    $.__views.__alloyId84.add($.__views.liftingPointsImage);
    ...
    $.__views.__alloyId89.add($.__views.liftingPointMeter);
    ...
    $.__views.__alloyId89.add($.__views.liftingPointFraction);
    ...
    setLength ? $.addListener($.__views.__alloyId92, "click", setLength) : __defers["$.__views.__alloyId92!click!setLength"] = true;
    ...
    __defers["$.__views.__alloyId82!click!closeModal"] && $.addListener($.__views.__alloyId82, "click", closeModal);
    __defers["$.__views.__alloyId92!click!setLength"] && $.addListener($.__views.__alloyId92, "click", setLength);
    _.extend($, exports);
}

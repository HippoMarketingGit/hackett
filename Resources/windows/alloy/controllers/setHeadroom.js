...
function Controller() {
    ...
    $.__views.setHeadroom.add($.__views.__alloyId166);
    ...
    closeModal ? $.addListener($.__views.__alloyId167, "click", closeModal) : __defers["$.__views.__alloyId167!click!closeModal"] = true;
    ...
    $.__views.setHeadroom.add($.__views.__alloyId168);
    ...
    $.__views.content.add($.__views.__alloyId169);
    ...
    $.__views.__alloyId175.add($.__views.headMeter);
    ...
    $.__views.__alloyId175.add($.__views.headFraction);
    ...
    setHead ? $.addListener($.__views.__alloyId178, "click", setHead) : __defers["$.__views.__alloyId178!click!setHead"] = true;
    ...
    $.__views.scrollView.add($.__views.__alloyId179);
    ...
    __defers["$.__views.__alloyId167!click!closeModal"] && $.addListener($.__views.__alloyId167, "click", closeModal);
    __defers["$.__views.__alloyId178!click!setHead"] && $.addListener($.__views.__alloyId178, "click", setHead);
    _.extend($, exports);
}
